...
### C++
- Create a class and implement copy constructor/assignments and operators
- Create a publisher/subscriber like so : `Publisher<YOURCLASS> publisher`
### Python
- Instructions are in `python_package/README.md`
### NodeJS
- Instructions are in `nodejs_package/README.md`
